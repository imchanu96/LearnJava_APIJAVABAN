...
public class GitHub1 {
	...
	/*
	 ...
	 - Committed : 로컬 데이터에 아전하게 저장 완료된 상태
	 ...
	 @git과 github의 차이점
	 git을 개인 컴퓨터에서 돌아가는 version cintrol system이다
	 ...
	 @소스코드 관리 서버
	 - git시스템을 사용하여 발생되는 소스코드의 변경 정보와 모든 소스코드 파일을
	 저장하기 위한 공간
	 ...
	 - 각 개발자들의 소스코드의 상태를 관리&저장해 주는 저장소 역활을 해주고 있음
	 
	 @깃허브의 커뮤니티 기능
	 - 깃허브 프로젝트 소개 홈페이지로도 활용 가능
	 - 깃허브 사이트에서 프로젝트 페이지에 접속시 현재 소스코드들이 보여짐
	 		누구나 문서를 생성할 수있도록 제공됨
	 - 질문과 답변 가능
	 - 이슈를 등록 및 상태 체크		
